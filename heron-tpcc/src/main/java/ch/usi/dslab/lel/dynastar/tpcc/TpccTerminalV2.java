...
public class TpccTerminalV2 {
    private final Random gen;

    private static final int NUM_TX = 1000000;
    private static final int warehouseCount = 10;
    ...
    // enable for change the workload to local only
    ...
    public TpccTerminalV2() {
        this.gen = new Random(System.nanoTime());
    }

    public static void main(String[] args) {
        TpccTerminalV2 t = new TpccTerminalV2();
        t.run();
    }
        ...
        for (int i = 0; i < numItems; i++) {
            if (sanityCheck)
                ...
                if (TpccUtil.randomNumber(1, 100, gen) > 1) {
                    ...
                    do {
                        supplierWarehouseIds[i] = TpccUtil.randomNumber(1, warehouseCount, gen);
                    }
    ...
    public void doPayment() {
        ...
        if (sanityCheck) {
            ...
            if (x <= 85) {
                ...
                while (customerWarehouseID == warehouseID && this.warehouseCount > 1);
            }
        }
